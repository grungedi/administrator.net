...
function wpmu_current_site() {
	...
	if ( 1 == count( $sites ) )
		...
		wp_die( /*WP_I18N_NO_SITE_DEFINED*/'Nenhum site definido neste servidor. Se você é o dono deste site, acesse a página <a href="http://codex.wordpress.org/Debugging_WPMU">Debugging WPMU</a> para ajuda (em inglês).'/*/WP_I18N_NO_SITE_DEFINED*/ );
}
...
function ms_not_installed() {
	...
	$msg .= /*WP_I18N_RTFM*/'Leia a página <a target="_blank" href="http://codex.wordpress.org/Debugging_WPMU">relatar bug</a>. Algumas das instruções lá podem ajudá-lo descobrir o que deu errado.'/*/WP_I18N_RTFM*/;
